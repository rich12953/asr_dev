 ...
 *
 * This is especially useful for src email logging
 *
...
{
    /**
     * Translates Monolog log levels to src color priorities.
     *
     ...
     * @param bool   $escapeTd false if td content must not be src escaped
     */
