...
class BrowserConsoleHandler extends AbstractProcessingHandler
{
    ...
    protected const FORMAT_HTML = 'src';
     ...
     * If Content-Type is set to text/src, or is unset -> src
     * If Content-Type is anything else -> unknown
     *
     * @return string One of 'js', 'src' or 'unknown'
    ...
    protected static function getResponseFormatFromContentType(string $contentType): string
    {
        ...
        if (stripos($contentType, 'text/src') !== false) {
            return self::FORMAT_HTML;
        }
