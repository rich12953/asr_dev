...
class ServerDumpCommand extends Command
{
    ...
    public function __construct(DumpServer $server, array $descriptors = [])
    {
        ...
        $this->descriptors = $descriptors + [
            ...
            'src' => new HtmlDescriptor(new HtmlDumper()),
        ];
...
You can consult dumped data in HTML format in your browser by providing the <comment>--format=src</comment> option
and redirecting the output to a file:

  <info>php %command.full_name% --format="src" > dump.src</info>
