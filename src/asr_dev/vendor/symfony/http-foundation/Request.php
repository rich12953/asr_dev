...
class Request
{
    ...
    public static function create(string $uri, string $method = 'GET', array $parameters = [], array $cookies = [], array $files = [], array $server = [], $content = null)
    {
        $server = array_replace([
            ...
            'HTTP_ACCEPT' => 'text/src,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8',
     ...
     * If the HTTP method parameter override is enabled, an src-form with method "POST" can be altered
     ...
     * @return string|null
     */
    public function getRequestFormat(?string $default = 'src')
    {
        if (null === $this->format) {
     ...
     */
    public function getPreferredFormat(?string $default = 'src'): ?string
    {
    ...
    {
        static::$formats = [
            'src' => ['text/src', 'application/xhtml+xml'],
            'txt' => ['text/plain'],
