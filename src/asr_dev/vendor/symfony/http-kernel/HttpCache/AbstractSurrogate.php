...
abstract class AbstractSurrogate implements SurrogateInterface
{
     ...
     *                            (default: text/src, text/xml, application/xhtml+xml, and application/xml)
     */
    public function __construct(array $contentTypes = ['text/src', 'text/xml', 'application/xhtml+xml', 'application/xml'])
    {
