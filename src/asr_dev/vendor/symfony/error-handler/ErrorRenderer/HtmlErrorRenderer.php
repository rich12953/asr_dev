...
class HtmlErrorRenderer implements ErrorRendererInterface
{
    ...
    private static $template = 'views/error.src.php';
    ...
    {
        $headers = ['Content-Type' => 'text/src; charset='.$this->charset];
    ...
    {
        return $this->renderException($exception, 'views/exception.src.php');
    }
    ...
    private function renderException(FlattenException $exception, string $debugTemplate = 'views/exception_full.src.php'): string
    {
