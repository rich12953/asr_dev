...
abstract class Renderer
{
    ...
    protected function activeBreadcrumb(AbstractNode $node): string
    {
        ...
        if ($node instanceof DirectoryNode) {
            $buffer .= '         <li class="breadcrumb-item">(<a href="dashboard.src">Dashboard</a>)</li>' . "\n";
        }
    ...
    {
        return sprintf(
            '         <li class="breadcrumb-item"><a href="%sindex.src">%s</a></li>' . "\n",
            $pathToRoot,
            $node->name()
        );
    }
    ...
    protected function coverageBar(float $percent): string
    {
        ...
        $templateName = $this->templatePath . ($this->hasBranchCoverage ? 'coverage_bar_branch.src' : 'coverage_bar.src');
