...
final class Facade
{
    ...
    public function process(CodeCoverage $coverage, string $target): void
    {
        ...
        $directory->render($report, $target . 'index.src');
        $dashboard->render($report, $target . 'dashboard.src');
        ...
        foreach ($report as $node) {
            ...
            if ($node instanceof DirectoryNode) {
                ...
                $directory->render($node, $target . $id . '/index.src');
                $dashboard->render($node, $target . $id . '/dashboard.src');
            } else {
