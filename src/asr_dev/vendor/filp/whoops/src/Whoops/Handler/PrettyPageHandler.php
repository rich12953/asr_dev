...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        $templateFile = $this->getResource("views/layout.src.php");
        ...
        $vars = [
            ...
            // Template paths:
            "header"                     => $this->getResource("views/header.src.php"),
            "header_outer"               => $this->getResource("views/header_outer.src.php"),
            "frame_list"                 => $this->getResource("views/frame_list.src.php"),
            "frames_description"         => $this->getResource("views/frames_description.src.php"),
            "frames_container"           => $this->getResource("views/frames_container.src.php"),
            "panel_details"              => $this->getResource("views/panel_details.src.php"),
            "panel_details_outer"        => $this->getResource("views/panel_details_outer.src.php"),
            "panel_left"                 => $this->getResource("views/panel_left.src.php"),
            "panel_left_outer"           => $this->getResource("views/panel_left_outer.src.php"),
            "frame_code"                 => $this->getResource("views/frame_code.src.php"),
            "env_details"                => $this->getResource("views/env_details.src.php"),
